...
export function DocumentoImpressao({ clienteNome, validade, itens = [], valorTotalGeral = 0, status }: DocumentoProps) {
  ...
  return (
    <>
      <style>{`
        /* Esconde o container na tela normal */
        .container-impressao-secreta {
          position: absolute;
          left: -9999px;
          top: -9999px;
          width: 1px;
        ...
        /* Configuração exclusiva para o momento do PDF */
        @media print {
          body * {
            visibility: hidden !important;
          }
          .container-impressao-secreta, .container-impressao-secreta * {
      ...
      <div className="container-impressao-secreta" style={{ padding: '40px', fontFamily: 'Arial, sans-serif', color: '#334155' }}>
        {/* Cabeçalho */}
